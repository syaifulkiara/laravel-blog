...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($kategori->nama); ?>">
...
unset($__errorArgs, $__bag); ?>" name="keterangan" rows="3"><?php echo e($kategori->keterangan); ?></textarea>
            </div>
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blogs\resources\views/kategori/edit.blade.php ENDPATH**/ ?>