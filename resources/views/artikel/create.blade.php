            ...
            <div class="col-md-9">
              <form action="{{route('artikel.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul') }}" placeholder="Judul Artikel">
                  @error('judul')
                      <strong class="text-danger">{{ $message }}</strong>
                      @enderror
                </div>
                <div class="form-group">
                  <textarea class="form-control @error('konten') is-invalid @enderror"  value="{{ old('konten') }}" name="konten" id="editor1"></textarea>
                  @error('konten')
                      <strong class="text-danger">{{ $message }}</strong>
                      @enderror
                </div>
              ...
              <div class="col-md-3">
                ...
                <a href="#" class="thumbnail">
                  <img id="preview-image-before-upload" src="{{asset('images/300.png')}}">
                </a>
                <div class="form-group">
