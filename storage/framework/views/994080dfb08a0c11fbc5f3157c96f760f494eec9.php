...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('themes/back/dist/css/skins/_all-skins.min.css')); ?>">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu navbar-left">
       <ul class="nav navbar-nav">
          ...
          <li>
            <a href=""> <?php echo e(Carbon\Carbon::now()->locale('id_ID')->isoFormat('LL')); ?></a>
          </li>
          <li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php echo e((request()->is('artikel','artikel/create')) ? 'active' : ''); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(route('artikel.index')); ?>"><i class="fa fa-circle-o"></i> Semua Artikel</a></li>
            <li><a href="<?php echo e(route('artikel.create')); ?>"><i class="fa fa-circle-o"></i> Buat Artikel</a></li>
          </ul>
        </li>
        ...
        <li class="<?php echo e((request()->is('komentar')) ? 'active' : ''); ?>">
          <a href="<?php echo e(route('komentar.index')); ?>">
        ...
        <li class="<?php echo e((request()->is('halaman','halaman/create')) ? 'active' : ''); ?>">
          <a href="<?php echo e(route('halaman.index')); ?>">
       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo e((request()->is('home')) ? 'active' : ''); ?>">
         ...
         <li class="<?php echo e((request()->is('profil')) ? 'active' : ''); ?>">
          <a href="<?php echo e(route('profil.index')); ?>">
...
<!-- SlimScro -->
<script src="<?php echo e(asset('themes/back/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
<!-- FastClick -->
<script src="<?php echo e(asset('themes/back/bower_components/fastclick/lib/fastclick.js')); ?>"></script>
<!-- AdminLTE App -->
<script src="<?php echo e(asset('themes/back/dist/js/adminlte.min.js')); ?>"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo e(asset('themes/back/dist/js/demo.js')); ?>"></script>
<?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\blogs\resources\views/layouts/backend.blade.php ENDPATH**/ ?>